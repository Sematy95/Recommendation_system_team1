...
public enum BaseProducts {
    ...
    TOP_SAVING_UUID("59efc529-2fff-41af-baff-90ccd7402925"),
    TOP_SAVING_NAME("Top Saving"),
    TOP_SAVING_TEXT("Откройте свою собственную «Копилку» с нашим банком! «Копилка» — это уникальный банковский инструмент, который поможет вам легко и удобно" +
    ...
    SIMPLE_LOAN_UUID("ab138afb-f3ba-4a93-b74f-0fcee86d447f"),
    SIMPLE_LOAN_NAME("Простой кредит"),
    SIMPLE_LOAN_TEXT("Откройте мир выгодных кредитов с нами!" +
