...
/**
 * Configuration class for creating and managing the Telegram Bot instance.
 * This class reads the Telegram bot token from the application properties and
 * creates a TelegramBot bean that can be injected into other components.
 */
@Configuration
